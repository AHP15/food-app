Rails.application.routes.draw do
  ...
  get '/users/:uvser_id/foods/:id', to: 'foods#delete'
  ...
  get '/users/:user_id/recipes/:id/ingredient', to: 'recipes#ingredient'
  post '/users/:user_id/recipes/:id/ingredient/create', to: 'recipes#create_ingredient'
end
